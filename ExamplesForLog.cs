...
// This file is part of the Speedshard repository from https://github.com/remyCases/ExamplesForLogMod.
...
public class ExamplesForLog : Mod
{
    public override string Author => "zizani";
    public override string Name => "ExamplesForLog";
